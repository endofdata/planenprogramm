...
namespace Planenprogramm.Migrations
{
    ...
    [Migration("20220821193923_damage_codes")]
    partial class damage_codes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Planenprogramm.Entities.Damage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Planenprogramm.Entities.TarpDamage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Planenprogramm.Entities.TarpDamage", b =>
                {
                    b.HasOne("Planenprogramm.Entities.Damage", "Damage")
                        .WithMany("TarpDamages")
                        .HasForeignKey("DamageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Planenprogramm.Entities.Tarp", "Tarp")
                        .WithMany("TarpDamages")
                        .HasForeignKey("TarpId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
